  ...
  return (
    ...
    >
      <div className="flex items-center gap-8">
        {/* Logo Area */}
        <div className="flex items-center gap-2 cursor-pointer text-netflixRed font-bold text-2xl tracking-tighter">
          <Camera size={28} />
          <span>STUDIO</span>
        </div>
        ...
        <ul className="hidden md:flex gap-6 text-sm font-medium text-gray-200">
          <li className="cursor-pointer hover:text-gray-400 transition">בית</li>
          <li className="cursor-pointer font-bold hover:text-white transition">גלריות</li>
          <li className="cursor-pointer hover:text-gray-400 transition">וידאו</li>
          <li className="cursor-pointer hover:text-gray-400 transition">המלצות</li>
        </ul>
      </div>
      ...
      <div className="flex items-center gap-6 text-white">
        ...
        <button className="bg-netflixRed hover:bg-red-700 text-white text-sm font-bold px-4 py-1.5 rounded-sm transition shadow-md">
          הזמן צילום
        </button>
      </div>
    </nav>
